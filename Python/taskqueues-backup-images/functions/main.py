...
import google.auth
import requests
from firebase_admin import functions, initialize_app, storage
from firebase_functions import https_fn, params, tasks_fn
...
BACKUP_BUCKET = params.StringParam(
    "BACKUP_BUCKET", input=params.ResourceInput(type=params.ResourceType.STORAGE_BUCKET)
).value
