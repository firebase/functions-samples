...
const elasticId = defineString('ELASTIC_ID', {
  label: 'Elastic ID',
  description: 'Elastic ID. Formerly functions.config().elastic.id',
});
const elasticUsername = defineString('ELASTIC_USERNAME', {
  label: 'Elastic Username',
  description: 'Elastic username. Formerly functions.config().elastic.username',
});
const elasticPassword = defineSecret('ELASTIC_PASSWORD', {
  label: 'Elastic Password',
  description: 'Elastic password. Formerly functions.config().elastic.password',
});
